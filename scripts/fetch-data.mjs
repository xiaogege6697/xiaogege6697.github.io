...
const classify = repo => {
  ...
  if (/minimal|maintenance-capsule|守核|窄腰|项目维护/.test(text)) return 'core';
  if (/cognitive-path|comic|漫画|图文|content/.test(text)) return 'content';
...
const labels = { core:'项目守核', agent:'自主执行', content:'内容生产', memory:'长期记忆', distill:'认知蒸馏', knowledge:'知识建模', infra:'基础设施' };
